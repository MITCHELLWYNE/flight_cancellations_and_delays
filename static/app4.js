...
////////////////////////////////////////
    ...
    function updateLineGraph(airport) {
      ...
      updateLineGraphPlot(filteredData);
    ...
    function updateDelaysData(data) {
      ...
      let xDataDel = DelPoints.map(data => data.month);
      let yDataDel = DelPoints.map(data => data.arr_flights);
    }
  

      let CalPoints = data.map(data => ({   
        month: data.month,
      ...
      let xDataCan = CalPoints.map(data => data.month);
      let yDataCan = CalPoints.map(data => data.arr_flights);
